<footer class="text-center text-white">
    <div class="container">
        ...
        <section class="mt-5">
            <div class="row text-center d-flex justify-content-center pt-5">
                ...
                <div class="col-md-2">
                    <h6 class="text-uppercase">
                        <a href="/aboutMe.php" class="text-white">Qui suis-je ?</a>
                    </h6>
                </div>

                <div class="col-md-2">
                    <h6 class="text-uppercase">
                        <a href="/contactez-moi.php" class="text-white">Contact</a>
                    </h6>
                </div>
                <div class="col-md-2">
                    <h6 class="text-uppercase">
    ...
    <!-- Copyright -->
    <div id="copy" class="d-flex justify-content-center">
        <p>© 2023 Copyright:</p>
        <a class="ps-1" href="/contactez-moi.php">Julie Guery, diéticienne et nutrionniste</a>
        <p class="ps-1">| numéro adélie : 00 00 00 00</p>
    </div>
</footer>
